...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="py-12 px-6 bg-gray-50 text-gray-800 w-screen">
        <h2 className="text-4xl font-bold text-center mb-12">Explore More Features</h2>
        <div className="flex flex-wrap justify-center gap-10 max-w-screen-xl mx-auto">
          <FeatureCard title="Course Management" description="Manage your courses easily with our intuitive interface." icon="📚" />
          <FeatureCard title="Course List" description="Browse and enroll in various courses at your convenience." icon="📝" />
          <FeatureCard title="Dashboard" description="Monitor your learning progress and achievements." icon="📊" />
        </div>
        <div className="text-center mt-10">
          <Link to="/courses" className="bg-blue-900 text-white px-6 py-3 rounded-full font-semibold shadow-md hover:bg-blue-700 mr-4">
            Course Management
          </Link>
          <Link to="/courselist" className="bg-blue-900 text-white px-6 py-3 rounded-full font-semibold shadow-md hover:bg-blue-700 mr-4">
            Course List
          </Link>
          <Link to="/dashboard" className="bg-blue-900 text-white px-6 py-3 rounded-full font-semibold shadow-md hover:bg-blue-700">
            Go to Dashboard
          </Link>
        </div>
      </section>
